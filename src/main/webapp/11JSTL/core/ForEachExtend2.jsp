...
<body>
	...
	저장된 인스턴스의 개수만큼 반복해서 전달된다. -->
	<c:forEach items="${ lists }" var="list">
	<li>
		<!-- 저장된 순서대로 Person인스턴스를 변수 list에 저장한 후
		getter를 통해 값을 출력한다. -->
	...
	<%
	/* Java코드를 사용하면 출력할 인스턴스 명시 후 getter를 직접 호출해야 한다. */
	...
	<!-- Map 사용시 key를 별도로 얻어올 필요없이 변수명.key혹은 
