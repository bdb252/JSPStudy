...
<body>
    ...
    <!-- 
    Tomcat8부터는 EL에서 변수할당이 가능하다. 단 할당과 동시에 출력되므로
    ;''을 추가해야 출력되지 않는다.
    ...
    Integer.parseInt()를 적용한 것과 동일한 결과를 반환한다.  -->
    num1 + "34" : ${ num1 + "34" } <br />
    <!-- 하지만 숫자와 문자열 or 문자열과 문자열의 경우에는
    덧셈 연산이 불가능하므로 예외가 발생된다. -->
    num2 + "이십" : \${num2 + "이십" }  <br /> 
    "삼십" + "사십" : \${"삼십" + "사십" } 
	...
	<!-- 
	논리 And, 논리 Or 사용시 &&, || 대신 영문자 형식의 연산자를 사용할 수 있다. 
	 -->
    <h3>논리 연산자</h3>
