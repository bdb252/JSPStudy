...
<body>
	...
	<!-- 
	4가지 영역에 접근할때는 EL의 내장객체를 통해 출력한다. 
	...
	<!-- 
	포워드를 사용할때는 JSP 코드보다는 액션태그가 좀 더 편리하다.
	포워드란 현재페이지가 받은 요청을 그 다음 페이지로 전달하는 것이다.
	즉 요청을 공유하는 개념이므로 request영역이 공유된다.
	 -->
	 <!-- 메인만 확인하려면 아래 주석에 포워드문 넣어서 확인 -->
	 <%--
	  --%>
