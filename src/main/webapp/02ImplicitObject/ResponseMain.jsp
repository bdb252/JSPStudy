...
<body>
    ...
    <%
    /*
    GET 방식으로 전달된 loginErr 파라미터가 있는 경우에만 "로그인실패"를 출력한다.
    첫 실행시에는 파라미터가 없는 상태이므로 메시지는 출력되지 않는다. */
    String loginErr = request.getParameter("loginErr");
    if (loginErr != null) out.print("로그인 실패");
    %>
    <!-- 
    로그인을 위해 POST 방식으로 폼값을 전송한다. 로그인 정보는 보안에 민감하므로
    주소줄에 남기지 않기 위해 POST방식을 사용해야 한다. -->
